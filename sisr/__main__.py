...
def parse_args() -> argparse.Namespace:
    ...
    crop_group.add_argument("--instagram-crop", action="store_true", help="Enable Instagram square crop")
    crop_group.add_argument("--hd-crop", choices=["center", "keep_top", "keep_bottom"], help="HD crop type")
    crop_group.add_argument("--uhd-crop", choices=["center", "keep_top", "keep_bottom"], help="UHD crop type")
    
    # Overlay options
    overlay_group = parser.add_mutually_exclusive_group()
    overlay_group.add_argument("--overlay-date", action="store_true", help="Add date overlay")
    overlay_group.add_argument("--overlay-frame", action="store_true", help="Add frame number overlay")
    
    # Quality options
    parser.add_argument("--quality", choices=["default", "prores", "proreshq", "gif"],
                       default="default", help="Output quality")
